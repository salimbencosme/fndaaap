            ...
            <div class="row">
                <div class="col-md-4 col-xs-12 block">
                    ...
                    <div class="col-md-10 col-xs-10">
                        ...
                        <a href="#" class="readmore">Read More <i class="fa fa-caret-right blue-special"></i></a>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12 block">
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-7 col-md-offset-5 col-sm-8 col-sm-offset-2 col-xs-12 text-inner ">
                <div class="text-block">
                    ...
                    <ul class="aboutul">
                        <li> <i class="fa fa-check blue-special"></i>Vix denique fierentis ea saperet inimicu ut qui dolor oratio mnesarchum.</li>
                        <li> <i class="fa fa-check blue-special"></i>legimus copiosae instructior ei ut vix denique fierentis atqui mucius consequat ad pro.</li>
                        <li> <i class="fa fa-check blue-special"></i>Ea saperet inimicu ut qui dolor oratio maiestatis ubique mnesarchum.</li>
                        <li> <i class="fa fa-check blue-special"></i>Sanctus voluptatibus et per illum noluisse facilisis quo atqui mucius ad pro.</li>
                        <li> <i class="fa fa-check blue-special"></i>At illum noluisse facilisis quo te dictas epicurei suavitate qui his ad.</li>
                        <li> <i class="fa fa-check blue-special"></i>Tantas propriae mediocritatem id vix qui everti efficiantur an ocurreret consetetur.</li>
                    </ul>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12 block ">
                    ...
                    <div class="testimonial_user">
                        <div class="user-image"><img src={user} alt="user" class="img-responsive" /></div>
                        <div class="user-info">
                            <h5>Lorem Ipsum</h5>
                            <p>Manager</p>
                        </div>
